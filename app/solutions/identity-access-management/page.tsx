...
const pageConfig = {
  title: 'Identity & Access Management (IAM)',
  tagline: 'Build a robust security posture with comprehensive identity and access management solutions. From zero trust implementation to identity governance, protect your critical assets.',
  breadcrumbs: [
    { label: 'Home', href: '/' },
